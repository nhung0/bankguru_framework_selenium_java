...
public class baseTest {
	...
	protected WebDriver getBrowserDriver(String browserName) {
		...
		if (browser == browserList.FIREFOX) {
			...
			File chromeFile = new File(globalConstants.BROWSER_EXTENSION + "adblock.crx");
			ChromeOptions chpotion = new ChromeOptions();
			chpotion.addExtensions(chromeFile);
			driver = new ChromeDriver(chpotion);
	...
	protected WebDriver getBrowserDriver(String url, String browserName) {
		Path path = null;
		File extentionFilePath = null;
		browserList browser = browserList.valueOf(browserName.toUpperCase());
		if (browser == browserList.FIREFOX) {
			

			driver = new FirefoxDriver();
			Path xpiPath = Paths.get(globalConstants.BROWSER_EXTENSION + "adblockplus.xpi");
...
//			path = Paths.get(globalConstants.BROWSER_EXTENSION + "adblock.crx");
//			path = Paths.get(globalConstants.BROWSER_EXTENSION + "uBlock.crx");
//			extentionFilePath = new File(path.toUri());
//			options.addExtensions(extentionFilePath);
			...
			path = Paths.get(globalConstants.BROWSER_EXTENSION + "uBlock.crx");
			extentionFilePath = new File(path.toUri());
			eoptions.addExtensions(extentionFilePath);
